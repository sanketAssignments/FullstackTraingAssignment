...
public class FindEvenOddPerfectPrime5 {
	...
	public static void main(String[] args) {
		...
		FindEvenOddPerfectPrime5 feopp = new FindEvenOddPerfectPrime5();
		feopp.checkEvenNumber(arr);
		feopp.checkOddNumber(arr);
		feopp.checkPrimeNumber(arr);
		feopp.checkPerfectNumber(arr);
	}
