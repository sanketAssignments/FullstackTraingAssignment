...
public class CollarInformation9 {
	...
	public CollarInformation9 (double[] callersize) {
    super();
    this.callersize = callersize;
}
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			try {
				if (count > 5) {
					throw new CollarStandardDeviateException9("CollarStandardDeviateException");
				}
			} catch (CollarStandardDeviateException9 e) {
