	       ...
	       try {
	            if (selection == 1) {
	                ...
	                if (time >= 23 && time <= 1) {
	                    ...
	                    throw new PassangerDetailException5("BookingNotAllowedException ");
	                ...
	                if (inputage > 5) {
	                    ...
	                    if (number > 0 && number <= 6) {
	                        ...
	                        throw new PassangerDetailException5("normalTicketBookingException");
	                    }
	                   ...
	                   System.out.println("Enter age of passenger");
	                    ...
	                    if (inputage > 5) {
	                        ...
	                        if (number > 0 && number <= 4) {
	                            ...
	                            throw new PassangerDetailException5("booking limit exceed");
	                        }
	                    ...
	                    System.out.println("only 6 are allowed");
	                    throw new PassangerDetailException5("TatkalTicketBookingException");
	                }
