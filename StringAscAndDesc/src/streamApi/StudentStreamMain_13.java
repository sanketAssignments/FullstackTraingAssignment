...
public class StudentStreamMain_13 {
	...
	public static void main(String[] args) {
	       ...
	       StudentStream_13 s1 = new StudentStream_13(101, doa, date_ob, 67, 65, 78, 76, 49, "class10th");
	       StudentStream_13 s2 = new StudentStream_13(102, doa, date_ob, 34, 54, 34, 23, 21, "class10th");
	       StudentStream_13 s3 = new StudentStream_13(103, doa, date_ob, 88, 45, 34, 76, 49, "class10th");
	       StudentStream_13 s4 = new StudentStream_13(104, doa, date_ob, 85, 88, 78, 76, 76, "class10th");



	       List<StudentStream_13> list = Arrays.asList(s1, s2, s3, s4);
	       ...
	       HashMap<StudentStream_13, Integer> hm = new HashMap<>();
	        hm.put(s1, avg1);
	        hm.put(s2, avg2);
	        hm.put(s3, avg3);
	        hm.put(s4, avg4);
	       ...
	       // Student key = Collections.max(hm.entrySet(),
	        ...
	        List<StudentStream_13> list1 = hm.entrySet().stream().filter(e -> e.getValue() < 40).map(Map.Entry::getKey)
	       ...
	       System.out.println("students who scored more than 75% in all \r\n" + "subject");
	        List<StudentStream_13> list2 = list.stream().filter(e -> e.getChemistry() > 75 && e.getEnglish() > 75
	       ...
	       List<StudentStream_13> list3 = list.stream().filter(e -> e.getChemistry() < 35 || e.getEnglish() < 35
	                || e.getHindi() < 35 || e.getMaths() < 35 || e.getPhysics() < 35).collect(Collectors.toList());
	        System.out.println(list3);



	       List<StudentStream_13> list4 = hm.entrySet().stream().filter(e -> e.getValue() > 40).map(Map.Entry::getKey)
	                .collect(Collectors.toList());
