...
public class ItemStream_11 {
	...
	public ItemStream_11(int itemid, String iname, LocalDateTime dom, LocalDateTime doe, float price) {
		super();
		this.itemid = itemid;
		this.iname = iname;
		this.dom = dom;
	...
	public ItemStream_11(String iname, float price) {
		this.iname = iname;
		this.price = price;
	}
