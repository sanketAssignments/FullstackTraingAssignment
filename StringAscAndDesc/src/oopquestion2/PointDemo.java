...
public class PointDemo {
	  ...
	  public static void main(String[] args)
	  {
		...
		Map<String,MyCrud> mt =new HashMap<String,MyCrud>();
		                     mt.put("point1",new  MyCrud(10,20));
		                     mt.put("point2",new  MyCrud(20,30));
		                     mt.put("point3",new  MyCrud(10,30));
		                     System.out.println("----in Traingle-----");
		                     MyCrud mc = mt.get("point1");
		                     System.out.println("vertex A has these coordinates:- "+mc.getX()+" "+ mc.getY());
		                     MyCrud mc1 = mt.get("point2");
		                     System.out.println("Vertex B vertex has these coordinates:- "+mc1.getX()+" "+ mc1.getY());
		                     MyCrud mc2 = mt.get("point3");
